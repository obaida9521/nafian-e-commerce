...
<div class="max-w-[560px] mx-auto">
    <div class="flex items-center justify-between mb-4 print:hidden">
        ...
        <button onclick="window.print()" class="inline-flex items-center gap-1.5 h-9 px-4 rounded-lg border border-[#E9E4E0] bg-white text-gray-700 text-[13px] font-semibold hover:border-wine-700"><x-ui.icon name="printer" :size="15" />Print receipt</button>
    </div>

    <div class="bg-white border border-[#E9E4E0] rounded-xl p-7" id="receipt">
        ...
        <div class="text-[12.5px] text-gray-600 space-y-1 mb-4 pb-4 border-b border-dashed border-[#E9E4E0]">
        ...
        <div class="space-y-2.5 mb-4 pb-4 border-b border-dashed border-[#E9E4E0]">
        ...
        <div class="space-y-1.5 text-[13px]">
            ...
            @endif
            <div class="flex justify-between text-[15px] font-semibold pt-1.5 border-t border-[#F5F2F0]"><span>Total</span><span>{{ $symbol }}{{ number_format($sale->total_amount, 0) }}</span></div>
